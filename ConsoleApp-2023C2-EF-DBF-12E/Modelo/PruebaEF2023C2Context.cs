...
{
    public partial class PruebaEF2023C2Context : DbContext
    {
        public PruebaEF2023C2Context()
        {
        }

        public PruebaEF2023C2Context(DbContextOptions<PruebaEF2023C2Context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=A-PROFH-360;Database=PruebaEF2023C2;Trusted_Connection=True;");
            }
        }
